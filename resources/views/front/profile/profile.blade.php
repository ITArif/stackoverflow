...
@section('contain')
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <div class="btn-group">
                    <a href="" class="btn btn-sm btn-default" type="button"> User Profile</a>
                    <a href="{{url('user/activity')}}" class="btn btn-sm btn-default" type="button"> Activity</a>
                    <a href="" class="btn btn-sm btn-default" type="button"> Devloper Story</a>
                </div>
