                    ...
                    <tbody>
                      @foreach($admins as $row)
                        <tr>
                         ...
                         <td>{{$row->email}}</td>
                         <td>{{$row->role}}</td>
                         <!-- jehetu ata admin er sathee link ase r amra relationship krsi tai avabe -->
                         <td>
                         ...
                         <td>
                           ...
                           <button id="{{$row->id}}" class="btn btn-danger btn-xs delete_permissions"><i class="fa fa-trash"></i>Delete</button>
                         </td>
                        </tr>
                      @endforeach
                    </tbody>
                 ...
                 $.ajax({
                     ...
                     success:function (response) {
                         ...
                         if(response==="success"){
                             Swal.fire({
                                 title: 'Success',
                                 text: "You Have Succefully Deleted The Permission",
                                 type: 'success',
